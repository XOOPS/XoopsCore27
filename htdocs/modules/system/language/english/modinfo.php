...
define('_MI_SYSTEM_PREFERENCE_MENUS_CACHE_TTL', 'Menus Cache TTL');
define('_MI_SYSTEM_PREFERENCE_MENUS_CACHE_TTL_DSC', 'Menu cache lifetime in seconds. Set to 0 to disable menu caching.');
...
define('_MI_SYSTEM_PREFERENCE_BREAK_CACHE', 'Cache');
